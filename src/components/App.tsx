...
function AppContent() {
  ...
  const naviState = useNaviState({
    ...
    isToolActive: voiceSession.isToolActive,
        ...
        <AnimatePresence>
          {mode === 'dashboard' && activeTab === 'finance' && (
            ...
            >
              <Finance 
                naviPosition={naviPosition}
                onPayBill={(allocation) => openPayment(allocation, 'bill')}
                onPayDebt={(allocation) => openPayment(allocation, 'debt')}
              />
            </motion.div>
          )}
        </AnimatePresence>
          ...
          {mode === 'dashboard' && (
            <div className="lg:hidden">
              <BottomNavBar
                ...
                isMainButtonActive={voiceSession.isConnected}
                naviPosition={naviPosition}
