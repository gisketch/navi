...
export function OvernightCardModal({ card, onClose }: OvernightCardModalProps) {
  // If card is null but component rendered (should be handled by parent AnimatePresence), default to low
